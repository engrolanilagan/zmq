...
{
    printf("mailbox.cpp recv _cpipe.read _active=%d\n", _active);
    ...
    printf("mailbox.cpp recv _signaler.wait timeout=%d\n", timeout_);
    int rc = _signaler.wait (timeout_);
    //printf("mailbox.cpp recv wait done.\n");
    if (rc == -1) {
    ...
    //  Receive the signal.
    printf("mailbox.cpp recv _signaler.recv_failble\n");
    ...
    //  Get a command.
    printf("mailbox.cpp recv _cpipe.read\n");
